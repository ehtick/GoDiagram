...
namespace Demo.Samples.BlockEditor {
  public partial class BlockEditor : DemoControl {
    ...
    public BlockEditor() {
      ...
      desc1.MdText = DescriptionReader.Read("Samples.BlockEditor.md");
...
{ ""From"": 6, ""To"": 8, ""Dir"": 2 }
    ...
    private void Setup() {
      ...
      // diagram properties
      _Diagram.Padding = 20;  // extra space when scrolled all the way
      _Diagram.Grid =  // a simple 10x10 grid
      ...
      _Diagram.HandlesDragDropForTopLevelParts = true;
        ...
        Builder.Make<Adornment>("ToolTip")
          .Add(
            new Panel("Vertical") {
              ...
              .Add(
                new TextBlock { Font = new Font("Segoe UI", 13, Northwoods.Go.FontWeight.Bold), TextAlign = TextAlign.Center }
                  .Bind("Text"),
        ...
        new Group("Spot") {
          ...
          .Add(
            ...
            new TextBlock {
              ...
              Font = new Font("Microsoft Sans Serif", 12, Northwoods.Go.FontWeight.Bold, FontUnit.Point), Editable = true
            }
              .Bind(
                new Binding("Text"),
                new Binding("Stroke", "Color")
      ...
      _Diagram.GroupTemplate.SelectionAdornmentTemplate =
        new Adornment("Spot")
          .Add(
            new Panel("Auto")
              .Add(
      ...
      _Diagram.GroupTemplate.ContextMenu =
        Builder.Make<Adornment>("ContextMenu")
          .Add(
            LightFillButton1(),
            LightFillButton2(),
      ...
      _Diagram.LinkTemplate.SelectionAdornmentTemplate =
      ...
      _Diagram.LinkTemplate.ContextMenu =
        Builder.Make<Adornment>("ContextMenu")
          .Add(
            DarkColorButton1(),
            DarkColorButton2(),
              ...
              .Add(
                new Panel("Horizontal")
                  .Add(
                    ...
                    new Panel(PanelType.Spot) { Margin = new Margin(0, 0, 0, 2) }
                      .Add(
                        AllSidesButton(true),
