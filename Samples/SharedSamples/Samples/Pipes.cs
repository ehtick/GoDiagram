...
namespace Demo.Samples.Pipes {
  public partial class Pipes : DemoControl {
  ...
  ""LinkDataSource"": [
    ...
    { ""Key"": 109, ""From"": -10, ""To"": -9, ""Fid"": ""U2"", ""Tid"": ""U0"" }
      ...
      desc1.MdText = DescriptionReader.Read("Samples.Pipes.md");
    ...
    private void DefineNodeTemplate() {
      if (_SharedNodeTemplate != null) return;  // already defined
      ...
      _SharedNodeTemplate.ContextMenu =
    ...
    private void Setup() {
      _Diagram.InitialScale = 1.5;
      _Diagram.DefaultScale = 1.5;
      _Diagram.AllowLink = false; // no user-drawn links
      // use a custom DraggingTool instead of the standard one, defined below
      _Diagram.ToolManager.DraggingTool = new SnappingTool();
      ...
      _Diagram.NodeTemplateMap["Comment"] =
        new Node()
          .Add(
            new TextBlock {
              Stroke = "brown",
      ...
      _Diagram.LinkTemplate = new Link { Visible = false };
    ...
    private void SetupPalette() {
      ...
      _Palette.InitialScale = 1.2;
      _Palette.ContentAlignment = Spot.Center;
      DefineNodeTemplate();
      _Palette.NodeTemplate = _SharedNodeTemplate; // shared with the main Diagram
      _Palette.ToolManager.ContextMenuTool.IsEnabled = false;
      _Palette.Layout = new GridLayout {
