...
namespace Demo.Samples.IvrTree {
  public partial class IvrTree : DemoControl {
    ...
    public IvrTree() {
      ...
      Setup();
      desc1.MdText = DescriptionReader.Read("Samples.IvrTree.md");
    }
    ...
    private void Setup() {
      ...
      _Diagram.NodeTemplateMap.Add("Terminal", new Node(PanelType.Spot).Add(
        new Shape("Circle") {
