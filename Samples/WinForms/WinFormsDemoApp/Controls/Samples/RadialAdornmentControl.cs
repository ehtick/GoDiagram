...
namespace Demo.Samples.RadialAdornment {
  [ToolboxItem(false)]
  public partial class RadialAdornmentControl : DemoControl {
...
";
    ...
    private void Setup() {
      ...
      var selectionAdornment = new Adornment(PanelType.Spot) {
  ...
  public class SectorButton : Panel {
    ...
    public SectorButton(double angle, double sweep) : base(PanelType.Spot) {
