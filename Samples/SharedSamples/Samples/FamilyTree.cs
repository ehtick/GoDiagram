...
namespace Demo.Samples.FamilyTree {
  public partial class FamilyTree : DemoControl {
    ...
    public FamilyTree() {
      ...
      desc1.MdText = DescriptionReader.Read("Samples.FamilyTree.md");
    }
    ...
    private void Setup() {
      ...
      myDiagram.Add(
        new Part(PanelType.Table) {
          ...
          new TextBlock("Key") {
            Row = 0, Font = new Font("Segoe UI", 14, Northwoods.Go.FontWeight.Bold)
          }, // end row 0
          new Panel(PanelType.Horizontal) {
            ...
            new TextBlock("Males") { Font = new Font("Segoe UI", 13, Northwoods.Go.FontWeight.Bold) }
          ), // end row 1
          new Panel(PanelType.Horizontal) {
            Row = 2,
            Alignment = Spot.Left
            ...
            new TextBlock("Females") { Font = new Font("Segoe UI", 13, Northwoods.Go.FontWeight.Bold) }
          ) // end row 2
        )
      );
      ...
      var tooltipTemplate = Builder.Make<Adornment>("ToolTip").Add(
        new TextBlock {
          Font = new Font("Arial", 8, Northwoods.Go.FontWeight.Bold, FontUnit.Point),
          Wrap = Wrap.Fit,
          Margin = 5
